...
const Card = ({ pokemon }) => {
    ...
    return (
        <div className="relative w-72 h-96 bg-white shadow-lg rounded">
            ...
            <div className="absolute top-1 right-1 text-white bg-indigo-700 rounded p-1 cursor-pointer transform hover:scale-110 transition-all duration-75 ease-in-out">
